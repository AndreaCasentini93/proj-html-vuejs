<template>
    <section class="position-relative">
        ...
        <svg xmlns="http://www.w3.org/2000/svg" width="200" height="202" fill="#B2E0F6" class="cloud hidden_1199px">
        ...
        <img class="dotted_circle_1" src="../assets/images/maxcoach-shape-05.png" alt="dotted_circle_1">
        <img class="dotted_circle_2" src="../assets/images/maxcoach-shape-05.png" alt="dotted_circle_2">
        <!-- /DECORATIONS -->
    </section>
</template>
